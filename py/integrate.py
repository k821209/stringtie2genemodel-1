...
#main_dir      = './' 
#file_ag       = sys.argv[2] #main_dir+'transcripts.fasta.augustus.ath.complete.gff3.nosharp.genome.v1.gff'
#file_td       = sys.argv[3] #main_dir+'selected_mRNA_v4.gff'
file_td       = sys.argv[2]


#df_ag     = pd.read_csv(file_ag,sep='\t')
